...
I1 = uint8(255*rand(40,80))  %matriz entre 0 - 255

% MUESTRA LA INFORMACIÓN COMO UNA IMAGEN
imshow(I1)

I11 = I1/255; % matriz normalizada entre 0-1 matriz binaria entre 0 o 1
figure, imshow(I11)

I111 = double(I1)/255; %matriz entre 0 - 1
figure, imshow(I111)
...
% Poner rectangulo amarillo en imagen color
Ic_mod = Ic;
Ic_mod(100:150,200:400,1:2) = 255;
Ic_mod(100:150,200:400,3) = 0;
imshow(Ic),figure, imshow(Ic_mod)
