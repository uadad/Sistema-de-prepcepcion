...
load('DatosGenerados\espacioCcas-Knn.mat');
...
XoI=XoI(:,espacioCCas_Knn);

nombresProblemaOI=[];
nombresProblemaOI.descriptores = nombresProblema.descriptores(espacioCCas_Knn);
nombresProblemaOI.clases = {'Circulo-Triangulo','Cuadrado'};
nombresProblemaOI.simbolos = {'*r','*g'};


save('DatosGenerados\Knn.mat','nombresProblemaOI',"XoI","YoI","espacioCCas_Knn");
